...
public class TaskModeration(IOpenAiClient openAiClient, ITaskClient client) : TaskSolver<List<int>>(openAiClient, client, Utils.Consts.AiDevsDefs.TaskEndpoints.Moderation), ITaskModeration
{
