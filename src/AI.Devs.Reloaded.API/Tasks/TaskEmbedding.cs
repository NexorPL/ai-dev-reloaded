...
public class TaskEmbedding(IOpenAiClient openAiClient, ITaskClient client) : TaskSolver<List<float>>(openAiClient, client, AiDevsDefs.TaskEndpoints.Embedding), ITaskEmbedding
{
